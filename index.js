    ...
    inquirer.prompt(prompt.mainMenu).then(function ({ task }) {
        switch (task) {
            ...
            case "Remove Role":
                ...
                break;
            case "Exit":
                console.log(chalk.bgRedBright.black("You are now disconnected from the Employee Database."));
                    ...
                    .then((response) => {
                        ...
                        connection.query(
                            "INSERT INTO employee SET ?",
								...
								(err, res) => {
									if (err) throw err;
									console.log(chalk.bgCyanBright.black("\n" + res.affectedRows + " Employee added successfully!"));
...
function deleteEmployee() {
	console.log(chalk.bgRedBright.black("EMPLOYEE Removal:"));
		...
		inquirer
			...
			.then(function (answer) {
                ...
                connection.query(query, { id: answer.employeeId }, function (err, res) {
					...
					console.log(chalk.bgRedBright.black("\n" + res.affectedRows + "  Deleted successfully!"));
...
function deleteDepartment() {
	...
	var query = `SELECT e.id, e.dep_name FROM department e`;
...
function deleteRole() {
	console.log(chalk.bgRedBright.black("ROLE Removal:"));
